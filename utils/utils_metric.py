...
def calculate_psnr_on_defect_area(img1, img2, mask, border=0):
    '''
    calculate PSNR on defect area according to mask
    img1 and img2 have range [0,255] and mask has value 1 on valid pixels
    '''
    ...
    mask = (mask/255)
    img1 = (img1.transpose(2,0,1) * (1-mask)).astype(np.float64)
